...
@property (nonatomic,strong) UIButton                *titleBtn;//标题 和titleLabel功能完全一样，只是用label在剪切圆角的时候会出现黑边的bug
...
@property (nonatomic,assign) CGSize                 titleBtnSize;//自定义titleBtnSize的大小
