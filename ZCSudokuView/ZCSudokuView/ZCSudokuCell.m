...
- (UIButton *)titleBtn {
    if (!_titleBtn) {
        ...
        _titleBtn.titleLabel.font = [UIFont systemFontOfSize:15*_scale];
...
- (CGSize)titleBtnSize {
    _titleBtnSize = CGSizeEqualToSize(_titleBtnSize,CGSizeZero)?CGSizeMake(kSelfW,kSelfH/5.0):_titleBtnSize;
    return _titleBtnSize;
}
